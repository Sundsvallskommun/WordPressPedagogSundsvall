...
class SK_Global_Categories {
	...
	public function add_global_term_options() {
		add_options_page( __( 'Inställningar för Globala kategorier', 'sk' ), __( 'Globala kategorier', 'sk' ), 'manage_options', 'functions', array(
			$this,
			'global_term_options'
		) );
	}
	...
	public function activate() {
		...
		<label for="use">
			<input type="checkbox" id="use"
			       name="sk_use_global_categories[use]" <?php checked( $use_global_categories, 'on', true ); ?>> <?php _e( 'Aktivera', 'sk' ); ?>
		</label>
		...
		<select name="sk_hide_global_categories">
			...
			<?php if ( ! empty( $terms ) && ! is_wp_error( $terms ) ) : ?>
				<?php foreach ( $terms as $term ) : ?>
					<option
						value="<?php echo $term->term_id; ?>" <?php selected( $term->term_id, $hide_categories, true ); ?>><?php echo $term->name; ?></option>
				<?php endforeach; ?>
			<?php endif; ?>
		</select>
			...
			<fieldset>
				<?php foreach ( $post_types as $post_type ) : ?>
					...
					<label for="<?php echo $post_type; ?>">
						<input type="checkbox" id="<?php echo $post_type; ?>"
						       name="sk_use_global_categories[post_types][<?php echo $post_type; ?>]" <?php echo $checked; ?>> <?php echo $post_type; ?>
					</label><br>
				<?php endforeach; ?>
