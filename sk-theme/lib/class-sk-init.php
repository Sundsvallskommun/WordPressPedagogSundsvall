...
class SK_Init {
	 ...
	 *
	 * Added inner-scroll element to fix a bug for -webkit-overflow-scrolling: touch on iOS.
	 *
	 * @since 1.0.0
	 *
	...
	public function wp_nav_menu( $nav_menu, $args ) {
		$nav_menu = '<nav class="of-sidebar-menu-advanced js-mobile-menu"><div class="of-sidebar-inner"><div class="inner-scroll">'. $nav_menu;
		$nav_menu .= '</div></div></nav>';
