...
class SK_Menus {
  public function __construct() {
   ...
   /**
   * Get dropdown navigation status
   * 
   * @since 1.0.0
   * 
   * @return boolean    true/false
   */
  public static function is_dropdown_activated(){

    // get dropdown settings from options
    $dropdown = get_field( 'sk_dropdown_nav', 'option' );
  
    if( isset( $dropdown[0] ) && $dropdown[0] == 'on' )
      return true;
