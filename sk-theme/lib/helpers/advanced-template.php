  ...
  <ul class="of-activity-list">
    <?php while( the_flexible_field( 'box_links', $box->post->ID ) ) : ?>
      ...
      <?php elseif ( get_row_layout() == 'external_link' ) : ?>
        <li>
          <header>
            <a href="<?php the_sub_field( 'link' ); ?>"<?php if ( get_sub_field( 'is_external' ) ) : ?> target="_blank"<?php endif; ?>>
              <?php the_sub_field( 'text' ); ?>
          ...
          <article <?php if ( has_post_thumbnail( $faq_post->ID ) ) : ?>class="sk-narrow"<?php endif; ?>>
            ...
            <div class="of-table box-qa-answers" cellpadding="0" cellspacing="0">
             ...
             <header class="faq-question">
                <h5 class="of-icon"> <i><svg viewBox="0 0 512 512"><use xlink:href="#posts"></use></svg></i><span>
                
                <?php echo $faq_post->post_title;?>
                </span><i class="arrow"><svg viewBox="0 0 512 512"><use xlink:href="#arrow-down"></use></svg></i></h5>
              </header>
              ...
              <div class="faq-answer">
               ...
               <div class="of-c-sm-3 of-c-xxl-8">
              ...
              <div class="of-c-sm-1 of-c-xxl-2">
                <a class="faq-open-link" href="<?php echo get_permalink( $faq_post->ID ); ?>"><span><?php _e('Direktlänk', 'sk'); ?></a>
              </div>
               </div><!-- .faq-related -->
              </div><!-- .faq-answer -->
